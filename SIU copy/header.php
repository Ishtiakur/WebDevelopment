  ...
  <header class="head container-fluid ">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <h1 class="head_title">Sylhet International University</h1>
        </div>
      </div>
    </div>
  </header>
    ...
    <nav class="mynavbar navbar navbar-default">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav myUl ">
				...
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Authority <span class="caret"></span></a>
				   <ul class="dropdown-menu">
					<li><a href="#">Syndicate</a></li>
					<li><a href="#">Academic Council</a></li>
					<li><a href="#">Office of the Register</a></li>
					<li><a href="#">Office of the Proctor</a></li>
					<li><a href="#">Office of the Treasurer</a></li>
					<li><a href="#">Office of the Chairman</a></li>
					<li><a href="#">Office of the office of the Vice Chancellor</a></li>
					<li><a href="#">Library Office</a></li>
					<li><a href="#">Department Officers</a></li>
				   </ul>
				</li>
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Faculty Member <span class="caret"></span></a>
				   <ul class="dropdown-menu">
					<li><a href="#">Computer Science and Engineering</a></li>
					<li><a href="#">Computer Science and Informatics</a></li>
				...
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Admission <span class="caret"></span></a>
				   <ul class="dropdown-menu">
					<li><a href="tuition-fees.html">Tution Fees</a></li>
					<li><a href="waiver-information.html">Waiver Information</a></li>
