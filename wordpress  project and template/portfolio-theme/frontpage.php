...
?>
  ...
  <body <?php body_class(  ); ?> id="page-top">
   ...
   <?php     }else{
    ...
    <!-- Header -->
    <?php 
     $attachment = wp_get_attachment_image_src(cs_get_option('header_background_image'), 'full' ); 
    ?>
    <header class="masthead" style ="background-image: url( <?php echo $attachment[0]  ?> );">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">
            <?php
              echo cs_get_option( 'heading_1' );
            ?>    

          </div>
          <div class="intro-heading text-uppercase">
            <?php
              echo cs_get_option( 'heading_2' );
            ?>
          </div>

          <?php if(cs_get_option('button_switcher')){    ?>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">  
                 <?php echo cs_get_option('button_text_id'); ?>
               </a>
          <?php  } ?>       
