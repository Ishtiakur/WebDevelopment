...
$settings           = array(
  ...
  'framework_title' => 'Customize Your Site <small>by Codestar</small>',
);
...
// ----------------------------------------
// a option header  section for options overview  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'HeaderContent',
  ...
  'fields'      => array(
    ...
    array(
      'id'      => 'heading_1',
      'type'    => 'text',
      'title'   => 'Head Section Content Title',
      'default' => 'do stuff',
       'help'    => 'Header Main Content Title.',
    ),
    // end: a field
    ...
    array(
      ...
      'help'    => 'Upload an Image for header Background logo.',
    ),
    array(
      'id'     => 'button_switcher',
      'type'   => 'switcher',
      'title'  => 'Button Enable or Disable',
      'default'=> 'Learn More'
    ),
    array(
      'id'     => 'button_text_id',
...
// sub section 1
    // ----------------------------------------
// a option first section after head section  -
// ---------------------------------------- 
    array(
      'name'        => 'FirstSection',
      'title'       => 'First Section',
...
// ----------------------------------------
// Second   section for options  -  // sub section 2
// ----------------------------------------
    array(
      'name'        => 'secondSection',
      ...
      'fields'      => array(
        ...
        // begin: a field
        array(
          'id'      => 'second_sec_subHeading',
          'type'    => 'text',
          'title'   => 'Second Section Sub Heading',
        ),
        // end: a field
        ...
        array(
          'id'              => 'second_sec_group',
          'type'            => 'group',
          'title'           => 'Second Secion Column Item',
          'button_title'    => 'Add New Column',
          'accordion_title' => 'Add New Field',
          'fields'          => array(
              // begin: a field
                array(
                  'id'      => 'second_sec_col_img',
                  'type'    => 'image',
                  'title'   => 'Coloumn Image',
                ),
                // end: a field
                ...
                // begin: a field
                array(
                  'id'      => 'second_sec_col_des',
                  'type'    => 'text',
                  'title'   => 'Column Desc',
                ),
            // end: a field
                array(
              'id'      => 'second_sec_col_hover_icon',
              'type'    => 'icon',
              'title'   => 'Portfolio Hover Icon',
              'default' => 'fa fa-heart',
            ),
      // end: a field
          ),
...
// ----------------------------------------
// third section about us section for options  // sub section 3
// ----------------------------------------
array(
  'name'        => 'thirdSection',
  'title'       => 'Third Section',
  ...
  'fields'      => array(
    ...
    // begin: a field
    array(
      'id'      => 'third_sec_subHeading',
      'type'    => 'text',
      'title'   => 'Third Section Sub Heading',
    ),
    // end: a field
     // begin: a field
     array(
      'id'      => 'timeline_image',
      'type'    => 'image',
      'title'   => 'Upload An Image For Timeline Sec',
    ),
     array(
      'id'      => 'timeline_image2',
      'type'    => 'image',
      'title'   => 'Upload An Image For Timeline Sec 2',
    ),  // end: a field
...
// ----------------------------------------
// fourth section team  section for options   // sub section 4 
// ----------------------------------------
array(
  'name'        => 'teamSection',
  ...
  'fields'      => array(
            array(
              'id'    => 'team_sec_heading', // this is must be unique
              'type'  => 'text',
              'title' => 'Fourth Section Heading ',
            ),
            array(
              'id'    => 'team_sec_sub_heading', // this is must be unique
              'type'  => 'text',
              'title' => 'Fourth Section Sub Heading ',
            ),
            array(
              ...
              'fields'          => array(
                      array(
                        'id'    => 'fourth_sec_col_image',
                        'type'  => 'image',
                        'title' => 'Upload Member Image',
                      ),
                      array(
                        'id'    => 'fourth_sec_col_name',
                        'type'  => 'text',
                        'title' => 'Member Name',
                      ),
                      array(
                        'id'    => 'fourth_sec_col_position',
                        'type'  => 'text',
...
// ----------------------------------------
// fifth section clients  section for options   // sub section 5 
// ----------------------------------------
              array(
                ...
                'fields'      => array(
                  array(
                    'id'    => 'contact_heading', // this is must be unique
                    'type'  => 'text',
                    'title' => 'Contact Section Heading',
                  ),
                  array(
                    'id'    => 'contact_sub_heading', // this is must be unique
                    'type'  => 'text',
                    'title' => 'Contact Section Sub Heading',
                  ),
                ),   //end of clients fields
              ),    //end of clientSection
