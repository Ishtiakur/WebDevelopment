...
/**
 * Created by Ishtiak on 10/28/2017.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Function.placeIdTask asyncTask =new Function.placeIdTask(new Function.AsyncResponse() {
            public void processFinish(String weather_city, String weather_description, String weather_temperature,
                                      String weather_humidity, String weather_pressure,
                                      String weather_updatedOn, String weather_iconText,
                                      String sun_rise) {
        ...
        asyncTask.execute("24.9045", "91.8611"); //  asyncTask.execute("Latitude", "Longitude")
